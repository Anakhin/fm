...
Macro {
  area="Editor"; key="AltF7"; flags=""; action = function()
    Keys("F7") 
  end;
}

Macro {
  area="Editor"; key="AltShiftF7"; flags=""; action = function()
    Keys("ShiftF7") 
  end;
}
...
Macro {
  area="Editor"; key="CtrlAltF7"; flags=""; action = function()
    Keys("CtrlF7") 
  end;
}
...
Macro {
  area="Shell"; key="AltShiftF6"; flags=""; action = function()
     Keys("ShiftF6 End BS Enter") 
  end;
}
...
Macro {
  area="Shell"; key="AltShiftF7"; flags=""; action = function()
    ...
    local folders = {"d:\\_other", mf.date("%Y"), mf.date("%Y.%m0.%d")}
    local full    = ""
...
Macro {
  area="Shell"; key="Ctrl'"; flags=""; action = function()
    Keys("CtrlY e d i t : < g Space d i Space . Enter F11 i d")
  end;
}
...
Macro {
  area="Shell"; key="CtrlAltF7"; flags=""; action = function()

    
    local folders = {"d:\\_other", mf.date("%Y"), mf.date("%Y.%m0.%d"), "home"}
    local full    = ""
...
NoMacro {
  area="Editor"; key="Tab"; flags="EVSelection"; description=""; action=function()
    Keys("AltI")
  end;
}

NoMacro {
  area="Editor"; key="ShiftTab"; flags="EVSelection"; description=""; action=function()
    Keys("AltU")
  end;
}

Macro {
   area="Editor Shell"; key="ShiftF4"; flags=""; description="Shift-F4 current";
   action = function()
     local name = nil
...
Macro {
  area="Other"; key="CtrlShiftG"; flags=""; description=""; action = function()
    Keys("ShiftEnd Enter g o t o : CtrlV Enter") 
  end;
}
